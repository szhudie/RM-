...
#include "pid.h"
#include "bsp_dma.h"
#define Chassis_Fb_Ramp  1000
#define Chassis_Lr_Ramp  300
//任务开始空闲一段时间
...
#define CHASSIS_VX_RC_SEN 25.0/660.0f
//遥控器左右摇杆（max 660）转化成车体左右速度（m/s）的比例
#define CHASSIS_VY_RC_SEN 20.0/660.0f
...
//底盘运动过程最大前进速度
#define NORMAL_MAX_CHASSIS_SPEED_X 55.0f
//底盘运动过程最大平移速度
#define NORMAL_MAX_CHASSIS_SPEED_Y 40.0f
//底盘设置旋转速度，设置前后左右轮不同设定速度的比例分权 0为在几何中心，不需要补偿
//#define CHASSIS_WZ_SET_SCALE 0.2f

//摇摆原地不动摇摆最大角度(rad)
#define SWING_NO_MOVE_ANGLE 50.0f
//摇摆过程底盘运动最大角度(rad)
#define SWING_MOVE_ANGLE 35.0f
...
//#define CHASSIS_FOLLOW_GIMBAL_PID_MAX_OUT 34.0f
...
typedef struct
{
  ...
  const motor_measure_t *chassis_yaw_motor;   //底盘使用到yaw云台电机的相对角度来计算底盘的欧拉角
